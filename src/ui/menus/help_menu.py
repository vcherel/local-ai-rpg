...
CONTROLS = [
    ...
    ("Shift", "Run"),
    ("Left Click", "Use what hand one is holding (swing, fire or throw it)"),
    ("Right Click", "Use what hand two is holding"),
    ...
    ("1 / 2", "Take up hand one's first or second weapon (empty means bare hands)"),
    ("3 / 4", "Same for hand two"),
