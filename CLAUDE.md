...
- `src/ui/minimap.py`: `Minimap`, explored cells and what stands on them plus rumour marks, with the village-name, mood, warning-countdown and day/night strips under it; `content_bottom` is where whatever stacks below hangs from
